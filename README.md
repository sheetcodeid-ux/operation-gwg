...
| Dokumen | Untuk siapa |
| --- | --- |
| **[Panduan Instalasi](docs/INSTALLATION.md)** | Developer baru — dari nol sampai aplikasi berjalan, ±15 menit |
| **[Integrasi Analisis Fraud](docs/FRAUD_INTEGRATION.md)** | Membangun penarikan data Void & Cancel dari POS ESB |
| **[`.env.example`](.env.example)** | Daftar seluruh variabel lingkungan beserta keterangannya |

Aplikasi berjalan penuh dalam **mode demo** tanpa kredensial apa pun — cukup
...
npm test           # vitest
npm run doctor     # environment check — run this first when something breaks
```
