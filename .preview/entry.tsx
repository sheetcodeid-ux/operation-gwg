...
const ANGKA: Record<string, [number | null, number | null, number | null]> = {
  ...
  do_monitor: [100, 90, 84], do_menu: [5, 6, 92], do_issue: [5, 4, 70],
  do_merchant: [3, 3, 100], do_tersedia: [100, 96, 88], do_gagal: [5, 3, 60],
  os_uptime: [100, 96.67, 95], os_masterdata: [5, 5, 100], os_menu: [5, 4, 76],
  os_issue: [5, 4, 82], os_error: [1, 0.6, 90], os_improve: [2, 2, 100], os_puas: [90, 87, 93],
  hc_jumlah_rekrutmen: [11, 11, 100], hc_waktu_rekrutmen: [21, 21, 100],
  hc_kualitas_rekrutmen: [10, 10, 100], hc_development: [4, 3, 100],
  hc_manajemen_kinerja: [20, 18.18, 92], hc_administrasi: [20, 20, 100],
