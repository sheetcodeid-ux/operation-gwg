...
export const outletToRow = (o: Outlet) => ({
  ...
  name: o.name,
  code: o.code,
  esb_branch_id: o.esbBranchId ?? null,
  gross_manual: !!o.grossManual,
  esb_mulai: o.esbMulai ?? null,
  esb_abaikan: o.esbAbaikan ?? null,
  buka_tanggal: o.bukaTanggal ?? null,
  city: o.city,
  area_id: fk(o.areaId),
...
export const outletFromRow = (r: any): Outlet => ({
  ...
  name: r.name,
  code: r.code,
  esbBranchId: r.esb_branch_id ?? null,
  grossManual: !!r.gross_manual,
  esbMulai: r.esb_mulai ?? null,
  esbAbaikan: r.esb_abaikan ?? null,
  bukaTanggal: r.buka_tanggal ?? null,
  city: r.city,
  areaId: r.area_id,
