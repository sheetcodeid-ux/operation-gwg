...
export interface ChatRef {
  kind: "pengajuan" | "hygiene" | "system" | "dokumen";
  id: string;
  title: string;
...
export function previewOf(m: {
  ...
  if (m.ref) {
    ...
    if (m.ref.kind === "system") return "Meneruskan sebuah request system";
    if (m.ref.kind === "dokumen") return "Meneruskan sebuah dokumen HC";
    return "Meneruskan sebuah pengajuan";
  }
